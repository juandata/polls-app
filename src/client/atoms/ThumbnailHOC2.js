...
var masInst = []; var pollCol = [];
 class ThumbnailHOC2 extends React.Component {
  constructor(props){
    super(props);
  ...
  componentWillMount(){
    ...
    let pollsArr = this.props.pollsInfo; console.log(pollsArr);
    ...
    let rowDiv = 12 / division;
          for(polls; 0 != polls; polls --){
            let unitPoll = (
              <Col xs={12} md={rowDiv} key={randomID(10)}>
                  <Thumbnail src={"data:image/png;base64," + pollsArr[polls -1].imageBase64}  alt="242x200" >
...
export default withRouter(connect(mapStateToProps)(ThumbnailHOC2))
